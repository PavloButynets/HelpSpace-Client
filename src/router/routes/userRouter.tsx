...
export const userRouter = (
  <Route
    element={
      <PrivateRoute
        role={[UserRoleEnum.Admin, UserRoleEnum.Moderator, UserRoleEnum.User]}
      />
    }
  >
    <Route
    ...
    />
    <Route element={<UserProfile />} path={userRoutes.userProfilePage.route} />
    <Route element={<MyEvents />} path={userRoutes.events.myEvents.route} />
    <Route element={<Chat />} path={userRoutes.chats.route} />
    <Route element={<Chat />} path={userRoutes.chat.route} />
  </Route>
)
