...
const eventData = {
    ...
    coverImage: 'https://platforma.volunteer.country/storage/organizationevent/9168/de32284242d112c777000ccceccbed4789cda944.png',
            ...
            <PageWrapper>
                <Box sx={styles.errorContainer}>
                    <Alert severity="error">
                        ...
                        <Typography>{error instanceof Error ? error.message : 'Unknown error occurred'}</Typography>
                    </Alert>
                </Box>
            </PageWrapper>
        );
