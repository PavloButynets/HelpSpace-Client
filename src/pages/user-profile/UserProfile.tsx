...
function getUser(id?: string) {
  ...
  return {
    ...
    skills: ['Управління подіями', 'Перша допомога', 'Навчання'],
    badges: [
      { name: 'Супер волонтер', description: 'Завершив 20+ подій' },
      { name: 'Організатор', description: 'Організував 5+ подій' },
      {
        name: 'Перша допомога',
        description: 'Швидко реагує на екстренні події'
      }
    ],
    rating: 4.8,
    reviewCount: 17
            ...
            <Card>
              ...
              <CardContent>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                  ...
                  <Typography color='text.secondary' variant='body2'>
                    ({userData?.feedbacks?.length ?? 0} відгуків)
                  </Typography>
                </Box>
              ...
              <CardContent>
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Typography>Загальна кількість годин</Typography>
                  </Box>
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Typography>Подій завершено</Typography>
                  </Box>
                  <Typography fontWeight='medium'>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Typography>Доєднався до платформи:</Typography>
                  </Box>
                  <Typography fontWeight='medium'>
          ...
          <Card>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
              <Tabs
                ...
                variant='fullWidth'
              >
                <Tab label='Відгуки' {...a11yProps(0)} />
                <Tab label='Статистика' {...a11yProps(1)} />
                <Tab label='Події' {...a11yProps(2)} />
              </Tabs>
            </Box>
            ...
            <TabPanel index={2} value={tabValue}>
              <UserEvents
                events={{
                  created: userData.eventsCreated || [],
                  participated: userData.assignedEvents
                }}
              />
            </TabPanel>
          </Card>
